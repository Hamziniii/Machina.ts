...
export class Machina {
     ...
     */
    evaluateMsg(msg: Message, checkPrefix = true, check?: (msg: Message) => boolean, mutator?: (msg: Message) => string): /** Value is the list of functions, reason is the reason why it works or fails, extra is just some extra info for debugging */MachinaResponse<MachinaFunction | MachinaFunction[]>{ // TODO custom prefixes per server, custom verification
